...
- **Linting Rule:** `.cursor/rules/linting.mdc` - Auto-applied rule for AI agent behavior
...
*This standard defines the linting requirements and policies. For AI agent behavior, see `.cursor/rules/linting.mdc`. For validation checklists, see `standards/process/checklists/linting_checklist_v1_0.md`.*
