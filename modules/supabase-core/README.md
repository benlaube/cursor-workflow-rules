...
```bash
cp -r modules/supabase-core /path/to/your/project/lib/supabase-core
```
...
```typescript
import { createClient } from '@/lib/supabase-core'
...
```typescript
import { createServerClient } from '@/lib/supabase-core'
...
```typescript
import { createServiceRoleClient } from '@/lib/supabase-core'
...
```typescript
import { queryBuilder } from '@/lib/supabase-core'
...
```typescript
import { paginate, parsePaginationParams } from '@/lib/supabase-core'
...
```typescript
import { uploadFile } from '@/lib/supabase-core'
...
```typescript
import { createSubscriptionManager } from '@/lib/supabase-core'
...
```typescript
import { normalizeError, getUserFriendlyMessage, SUPABASE_ERROR_CODES } from '@/lib/supabase-core'
...
```typescript
import { retryOperation } from '@/lib/supabase-core'
...
```typescript
import { globalCache, createCacheKey } from '@/lib/supabase-core'
...
- `modules/backend-api/` - API handler module (uses supabase-core)
- `modules/auth-profile-sync/` - Auth module (uses supabase-core)
- `modules/error-handler/` - Error handling module (integrated with supabase-core)
- `modules/logger-module/` - Logging module (integrated with supabase-core)
