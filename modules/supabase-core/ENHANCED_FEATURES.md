...
The `supabase-core` module now includes enhanced features for robust integration with automatic error handling, logging, and monitoring.
...
```typescript
import { safeQuery, safeMutation, safeStorage, safeAuth } from '@/modules/supabase-core'
...
```typescript
import { createEnhancedClient, createClient } from '@/modules/supabase-core'
...
```typescript
import { OperationInterceptor, createClient } from '@/modules/supabase-core'
...
```typescript
import { checkSupabaseHealth, createClient } from '@/modules/supabase-core'
...
```typescript
import { createSafeClient, createClient } from '@/modules/supabase-core'
...
```typescript
import { safeQuery } from '@/modules/supabase-core'
