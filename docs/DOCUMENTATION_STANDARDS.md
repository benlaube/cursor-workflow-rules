...
**Related Standards:**
- `standards/documentation.md` - How to manage and organize documentation (governing rules)
...
│   ├── INTEGRATION_GUIDE.md         # Main integration guide (or root level)
...
│   └── (Note: Checklists moved to `standards/development-checklists/` - see `standards/documentation.md` Section 4.4)
...
| Document | Location | When to Create |
|----------|----------|----------------|
| Integration Guide | `docs/integration/INTEGRATION_GUIDE.md` or root `INTEGRATION_GUIDE.md` | For reusable modules/libraries |
...
**Location:** `docs/process/` (this structure is required per `standards/documentation.md`)

| Document | Location | When to Create |
|----------|----------|----------------|
| Development Workflow | `docs/process/development_workflow_v1_0.md` | When establishing workflow |
| Checklists | `standards/development-checklists/*.md` | Required for validation |
| Process Standards | `docs/process/*_standards_v1_0.md` | For process requirements (if any exist) |

**Checklists Required:**
- `standards/development-checklists/pre-flight-checklist.md` - Environment validation
- `standards/development-checklists/pr-review-checklist.md` - Pre-PR validation
- `standards/development-checklists/project-audit-checklist.md` - Project structure validation
...
**Required:**
- Core Foundation (Section 2)
- `docs/integration/INTEGRATION_GUIDE.md` or root `INTEGRATION_GUIDE.md`
- `docs/api/API_REFERENCE.md`
...
- **Note:** See `standards/documentation.md` Section 5 for authoritative naming rules
- **Examples:**
...
Every documentation file must include metadata at the top. See `standards/documentation.md` Section 4 for complete format requirements.
...
- **`standards/documentation.md`** - Documentation management rules (governing standards)
- **`docs/DOCUMENTATION_STANDARDS.md`** - Comprehensive reference and checklist (this file)
...
- [ ] `standards/development-checklists/pre-flight-checklist.md`
...
- **`standards/documentation.md`** - Documentation management rules and metadata format (includes three-layer system explanation)
- **`standards/project-structure.md`** - Overall project file structure
...
│   └── CONTRIBUTING.md
└── /process
    └── (Note: Checklists moved to `standards/development-checklists/`)
```
...
*This document provides a comprehensive guide to standard documentation requirements. Start with the minimum viable documentation and expand as your project grows.*
