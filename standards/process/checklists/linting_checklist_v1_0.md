...
_This checklist provides validation items for linting at different stages. For detailed requirements, see `standards/process/code-quality-linting-standards.md`. For automated execution, use `.cursor/commands/validate-code-quality.md`._
